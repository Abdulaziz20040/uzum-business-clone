...
const IconLabels = () => (
    ...
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path className="to-red" opacity="0.5" d="M5.00012 3.66675C5.00012 2.56218 5.89555 1.66675 7.00012 1.66675H13.0001C14.1047 1.66675 15.0001 2.56218 15.0001 3.66675V5.00008H5.00012V3.66675Z" fill="#A1A1A1"></path>
    </svg>
);
...
const IconFinances = () => (
    ...
    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_2319_5177)">
            <path fillRule="evenodd" clipRule="evenodd" d="M18.791 12.834C19.5504 12.834 20.166 12.2184 20.166 11.459C20.166 10.6996 19.5504 10.084 18.791 10.084C18.0316 10.084 17.416 10.6996 17.416 11.459C17.416 12.2184 18.0316 12.834 18.791 12.834Z" fill="white"></path>
            <rect x="2.2002" y="4.99609" width="16.5" height="6.41667" rx="1" transform="rotate(-15 2.2002 4.99609)" fill="white"></rect>
            <path className="to-red" fillRule="evenodd" clipRule="evenodd" d="M3.83301 3.66797C2.72844 3.66797 1.83301 4.5634 1.83301 5.66797V16.3346C1.83301 17.4392 2.72844 18.3346 3.83301 18.3346H18.1663C19.2709 18.3346 20.1663 17.4392 20.1663 16.3346V14.3599C19.7496 14.5578 19.2834 14.6686 18.7913 14.6686C17.0194 14.6686 15.583 13.2322 15.583 11.4603C15.583 9.68837 17.0194 8.25195 18.7913 8.25195C19.2834 8.25195 19.7496 8.36273 20.1663 8.5607V5.66797C20.1663 4.5634 19.2709 3.66797 18.1663 3.66797H3.83301Z" fill="#666666"></path>
        </g>
        <defs>
...
const IconAnalytics = () => (
    ...
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect className="to-red" opacity="0.6" x="14.1668" y="3.33325" width="2.5" height="10.8333" rx="1.25" fill="white"></rect>
        <rect className="to-red" opacity="0.6" x="10.0001" y="7.5" width="2.5" height="6.66667" rx="1.25" fill="white"></rect>
        ...
        <rect className="to-red" opacity="0.6" x="5.83347" y="9.16675" width="2.5" height="5" rx="1.25" fill="white"></rect>
    </svg>
);

// --- Menu ro'yxatlari ---
const topMenu = [
    { name: "Tovarlar", icon: IconProducts, path: "/" },
